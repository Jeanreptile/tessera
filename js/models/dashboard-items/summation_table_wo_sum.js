ds.register_dashboard_item('summation_table_wo_sum', {

  display_name: 'Summation Table wo/sum',
  icon: 'fa fa-table',
  category: 'data-table',
  ...
  constructor: function(data) {
    ...
    var self = limivorous.observable()
                         ...
                         .property('title')
                         .extend(ds.models.item, {item_type: 'summation_table_wo_sum'})
                         .build()
  ...
  data_handler: function(query, item) {
    ...
    query.data.forEach(function(series) {
      body.append(ds.templates.models.summation_table_row_wo_sum({series:series, item:item}))
    })
  },

  template: ds.templates.models.summation_table_wo_sum,
